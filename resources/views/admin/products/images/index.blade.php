            ...
            <div class="panel panel-default">
              <div class="panel-body">
                ...
                <form method="post" action="">
                  ...
                  <button type="submit" class="btn btn-primary btn-round">Eliminar Imagen</button>
                  @if ($image->featured)
                    <button type="button" class="btn btn-info btn-just-icon" rel="tooltip" title="Imagen destacada actualmente">
